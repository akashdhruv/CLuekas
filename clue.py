...
class ClueEngine:
    cards = {}
    cards['suspect'] = ['Plum', 'Mustard', 'Green', 'Scarlet', 'Orchid', 'Peacock']
    cards['weapon'] = ['Knife', 'Candlestick', 'Revolver', 'Lead Pipe', 'Rope', 'Wrench']
    cards['room'] = ['Hall', 'Conservatory', 'Dining Room', 'Kitchen', 'Study', 'Library', 'Ballroom', 'Lounge', 'Billiard Room']
